...
public class MultiImageView extends LinearLayout {
    ...
    private int pxImagePadding = ConvertUtils.dp2px(6);// 图片间的间距
    ...
    public void setList(List<PhotoInfo> lists) throws IllegalArgumentException {
        ...
        if (MAX_WIDTH > 0) {
            ...
            pxOneMaxWandH = (int) (MAX_WIDTH *3 / 4);
...
//        }
    ...
    private ImageView createImageView(int position) {
        ...
        imageView.setBackgroundColor(getResources().getColor(R.color.dividerLine));

        GlideUtil.loadDefaultImg(getContext(), photoInfo.url, imageView);
