...
import com.surhoo.sh.common.util.PhotoViewpager;
...
public class ImagePagerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void addGuideView(LinearLayout guideGroup, int startPos, ArrayList<String> imgUrls) {
        if (imgUrls != null && imgUrls.size() > 0) {
            ...
            for (int i = 0; i < imgUrls.size(); i++) {
                ...
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ConvertUtils.dp2px(6),
    ...
    public void onReciveMessage(EventBusMessageBean msg) {
        switch (msg.getCode()) {
            case EventBusMessageBean.Img.closeImg:
                finish();
                break;
        }
    }
            ...
            if (view != null) {
                ...
                imageView.setOnPhotoTapListener(new PhotoViewAttacher.OnPhotoTapListener() {
                    ...
                    public void onPhotoTap(View view, float x, float y) {
                     EventBus.getDefault().post(new EventBusMessageBean(EventBusMessageBean.Img.closeImg));
                    }
...
//                loading
                ...
                options.diskCacheStrategy(DiskCacheStrategy.ALL).error(R.mipmap.default_img_square);
                Glide.with(context)
                        .asBitmap()
                        .load(imgUrl)
