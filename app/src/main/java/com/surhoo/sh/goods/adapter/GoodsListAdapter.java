...
public class GoodsListAdapter extends BaseQuickAdapter<GoodsBean
        , BaseViewHolder> {


    public GoodsListAdapter(int layoutResId, @Nullable List<GoodsBean> data) {
    ...
    protected void convert(@NonNull BaseViewHolder helper, GoodsBean item) {
        ...
        Glide.with(mContext).load(item.getLogo()).into(goodsImg);
